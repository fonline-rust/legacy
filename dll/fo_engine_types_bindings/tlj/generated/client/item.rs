...
pub struct ProtoItem {
    ...
    pub ColorContour: ::std::os::raw::c_int,
    pub MagicPower: ::std::os::raw::c_int,
    pub IndefineValue: uint16,
    pub IndefineStat: uint16,
    pub Unused: [uint8; 92usize],
    ...
    pub BurnTime: uint16,
    pub HeadItem_Perk: uint8,
    pub Partial_Item: uint8,
    pub Fuel_Efficiency: uint8,
    pub UnusedEnd: [uint8; 154usize],
    pub Item_Hitpoints: uint8,
    pub Fire_Strength: uint8,
    pub Blast_Radius: uint8,
    pub EffectSpeed: uint,
...
fn bindgen_test_layout_ProtoItem() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).ColorContour as *const _ as usize },
        228usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(ColorContour)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).IndefineValue as *const _ as usize },
        236usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(IndefineValue)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).IndefineStat as *const _ as usize },
        238usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(IndefineStat)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).Padding0 as *const _ as usize },
        489usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).BurnTime as *const _ as usize },
        566usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).HeadItem_Perk as *const _ as usize },
        568usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(HeadItem_Perk)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).Partial_Item as *const _ as usize },
        569usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(Partial_Item)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).Fuel_Efficiency as *const _ as usize },
        570usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(Fuel_Efficiency)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).Item_Hitpoints as *const _ as usize },
        725usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(Item_Hitpoints)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).Fire_Strength as *const _ as usize },
        726usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(Fire_Strength)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).Blast_Radius as *const _ as usize },
        727usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<ProtoItem>())).EffectSpeed as *const _ as usize },
        728usize,
        concat!(
            "Offset of field: ",
            stringify!(ProtoItem),
            "::",
            stringify!(EffectSpeed)
        )
    );
    assert_eq!(
...
fn bindgen_test_layout_Item() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Item>())).ColorContour as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(Item),
