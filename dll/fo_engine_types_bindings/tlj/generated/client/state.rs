...
pub struct GameOptions {
    ...
    pub RoofAlpha: uint8,
    pub WallAlpha: uint8,
    pub ShowContourContainer: bool,
    pub ShowContourItems: bool,
    pub ShowContourDoors: bool,
    pub ShowContourDeadCritters: bool,
    pub ShowContourScenery: bool,
    pub ShowContourWalls: bool,
    pub HideCursor: bool,
...
fn bindgen_test_layout_GameOptions() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GameOptions>())).WallAlpha as *const _ as usize },
        885usize,
        concat!(
            "Offset of field: ",
            stringify!(GameOptions),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GameOptions>())).ShowContourContainer as *const _ as usize
        },
        886usize,
        concat!(
            "Offset of field: ",
            stringify!(GameOptions),
            "::",
            stringify!(ShowContourContainer)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GameOptions>())).ShowContourItems as *const _ as usize },
        887usize,
        concat!(
            "Offset of field: ",
            stringify!(GameOptions),
            "::",
            stringify!(ShowContourItems)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GameOptions>())).ShowContourDoors as *const _ as usize },
        888usize,
        concat!(
            "Offset of field: ",
            stringify!(GameOptions),
            "::",
            stringify!(ShowContourDoors)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GameOptions>())).ShowContourDeadCritters as *const _ as usize
        },
        889usize,
        concat!(
            "Offset of field: ",
            stringify!(GameOptions),
            "::",
            stringify!(ShowContourDeadCritters)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GameOptions>())).ShowContourScenery as *const _ as usize },
        890usize,
        concat!(
            "Offset of field: ",
            stringify!(GameOptions),
            "::",
            stringify!(ShowContourScenery)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GameOptions>())).ShowContourWalls as *const _ as usize },
        891usize,
        concat!(
            "Offset of field: ",
            stringify!(GameOptions),
            "::",
            stringify!(ShowContourWalls)
        )
    );
    assert_eq!(
