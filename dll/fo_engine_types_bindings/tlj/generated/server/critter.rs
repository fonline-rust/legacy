...
fn bindgen_test_layout_NpcPlane() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NpcPlane>())).Delay as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(NpcPlane),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NpcPlane>())).IsNotProccess as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(NpcPlane),
            "::",
            stringify!(IsNotProccess)
        )
    );
    assert_eq!(
...
pub struct Critter {
    ...
    pub IsNotValid: bool,
    pub CanBeRemoved: bool,
    pub RefCounter: ::std::os::raw::c_long,
}
#[repr(C)]
...
fn bindgen_test_layout_Critter() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Critter>())).CanBeRemoved as *const _ as usize },
        9337usize,
        concat!(
            "Offset of field: ",
            stringify!(Critter),
            "::",
            stringify!(CanBeRemoved)
        )
    );
    assert_eq!(
